...
export async function generateMemberTemplate() {
  ...
  worksheet.columns = [
    { header: "Last Name", key: "last_name", width: 20 },
    { header: "First Name", key: "first_name", width: 20 },
    { header: "DOB (YYYY-MM-DD)", key: "date_of_birth", width: 20 },
    { header: "Gender", key: "gender", width: 10 },
    { header: "Marital Status", key: "marital_status", width: 15 },
    { header: "Age Group", key: "age_group", width: 15 },
    { header: "Address", key: "address", width: 25 },
    ...
    { header: "Invited By", key: "invited_by", width: 20 },
    { header: "Date Attended (YYYY-MM)", key: "date_attended", width: 20 },
    ...
    { header: "Life Class", key: "Victory Weekend", width: 20 },
    { header: "Life Class Year", key: "Life Class Year", width: 20 },
    { header: "SOL 1", key: "SOL 1", width: 20 },
    { header: "SOL 1 Year", key: "SOL 1 Year", width: 20 },
    { header: "SOL 2", key: "SOL 2", width: 20 },
    { header: "SOL 2 Year", key: "SOL 2 Year", width: 20 },
    { header: "SOL 3", key: "SOL 3", width: 20 },
    { header: "SOL 3 Year", key: "SOL 3 Year", width: 20 },
  ...
  for (let row = 2; row <= 100; row++) {
    ...
    const yesNoCols = ["I", "M", "P", "R", "T", "V", "X", "AA"];
    ...
    worksheet.getCell(`AC${row}`).dataValidation = {
      type: "list",
